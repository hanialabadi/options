...
USAGE:
    from core.shared.data_layer.ivhv_availability_loader import load_iv_availability
...
DERIVED_ANALYTICS_PATH = PROJECT_ROOT / 'data' / 'ivhv_timeseries' / 'ivhv_timeseries_derived.csv'
